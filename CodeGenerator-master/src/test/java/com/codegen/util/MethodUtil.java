...
public class MethodUtil {
     ...
     * @return
     */
    public static String typeConvert(String methodType,String type) {
        if(type!=null && methodType.contains("List") &&"list".equals(type)){
           return methodType.substring(methodType.indexOf("<")+1,methodType.indexOf(">"));
        }
    ...
    public static String getMethodParamType(String methodName, String methodParamType, String modelName) {
        ...
        if ("selectByCondition".equals(methodName)) {
            return "Integer page, Integer pageSize, Boolean useFlag";
        }
